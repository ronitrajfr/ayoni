  ...
  return (
    ...
    >
      ...
      <div>
        <button
          onClick={handleClick}
          className="bg-page-gradient font-geistSans group inline-flex w-[100%] cursor-pointer items-center justify-start gap-x-1 rounded-3xl px-4 py-3 text-lg font-semibold duration-200 hover:bg-transparent/10 hover:text-zinc-100 max-md:text-sm"
        >
          Get Started
