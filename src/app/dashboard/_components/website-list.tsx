      ...
      <div className="w-full text-left">
        <div className="border-b">
          <div className="flex px-4 py-3">
            <div className="bg-muted h-5 w-1/3 animate-pulse rounded"></div>
            <div className="bg-muted mx-4 h-5 w-1/3 animate-pulse rounded"></div>
            <div className="bg-muted ml-auto h-5 w-1/3 animate-pulse rounded"></div>
          </div>
        </div>
          ...
          {Array(3)
            ...
            .map((_, i) => (
              <div key={i} className="flex items-center px-4 py-4">
                <div className="bg-muted h-5 w-1/4 animate-pulse rounded"></div>
                <div className="bg-muted mx-4 h-5 w-1/3 animate-pulse rounded"></div>
